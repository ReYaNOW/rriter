...
pub struct Renderer {
    ...
    pub diag_popup_scroll: crate::scroll::ScrollState,
    pub max_diag_popup_scroll: f32,
    ...
    pub fn new(gl: glow::Context, scale_factor: f32, theme: Theme) -> Self {
        unsafe {
            ...
            let mut renderer = Self {
                ...
                last_diag_href: None,
                diag_popup_scroll: crate::scroll::ScrollState::new(15.0),
                max_diag_popup_scroll: 0.0,
