...
pub enum UiId {
    ...
    ApiMockStaticResponseScrollY(usize),
    ApiMockStaticResponseScrollX(usize),
    ...
    GitCommitOptionsToggle,
    GitCommitOptionsItem(usize),
    GitPush(usize),
