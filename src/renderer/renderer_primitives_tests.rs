impl Renderer {
    ...
    fn builtin_icon_svg(icon_type: crate::widgets::IconType) -> Option<&'static [u8]> {
        let data = match icon_type {
            ...
            crate::widgets::IconType::Database => include_bytes!("../icons/database.svg").as_slice(),
            crate::widgets::IconType::DatabaseTable => include_bytes!("../icons/database-table.svg").as_slice(),
            crate::widgets::IconType::Run => include_bytes!("../icons/run.svg").as_slice(),
            crate::widgets::IconType::Eye => include_bytes!("../icons/eye.svg").as_slice(),
