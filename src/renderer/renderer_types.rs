...
pub struct Renderer {
    ...
    pub glyphs: HashMap<(char, u8, u32), GlyphInfo>,
    pub ui_glyphs: HashMap<(char, u32), GlyphInfo>,
    ...
    pub phys_to_visual_line_count: usize,
    pub phys_to_visual_fold_count: usize,
    pub phys_to_visual_fold_checksum: u64,
